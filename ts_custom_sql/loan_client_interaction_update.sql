...
$BODY$
  ...
  COST 100;
ALTER FUNCTION collect.loan_client_interaction_update(bigint, integer, timestamp without time zone, integer, smallint, bigint, character varying, smallint, boolean)
  OWNER TO postgres;
